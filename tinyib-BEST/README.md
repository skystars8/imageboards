# i had ai update this app !! Ai took out the other modes and only sqlite3 remains. That was a design choice to make this simple to use. If you want any other db, start with THIS app because lots of work is done, and tell ai to make it work with postgres, mongo, mysql or whatever. 


# https://www.youtube.com/watch?v=JpRNBLB-5kE

# https://github.com/skystars8/imageboards


# BAM !! Below is the original readme. 

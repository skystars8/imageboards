...
// Time and date
define('TINYIB_TIMEZONE', 'UTC');                 // See https://www.php.net/manual/en/timezones.php - e.g. America/Los_Angeles
define('TINYIB_DATEFMT', 'y/m/d(D)H:i:s');        // Date and time format  (see php.net/manual/en/datetime.format.php)
...
// CAPTCHA: use 'simple' to enable the built-in image CAPTCHA (inc/captcha.php), or '' to disable
define('TINYIB_CAPTCHA', '');         // Require CAPTCHA when posting a new thread
define('TINYIB_REPLYCAPTCHA', '');    // Require CAPTCHA when posting a reply
define('TINYIB_REPORTCAPTCHA', '');   // Require CAPTCHA when reporting
define('TINYIB_MANAGECAPTCHA', '');   // Require CAPTCHA when logging in to the management panel
...
$tinyib_hidefieldsop = [];            // Fields to hide when creating a new thread - e.g. array('name', 'email', 'subject', 'message', 'file', 'embed', 'password')
$tinyib_hidefields = [];              // Fields to hide when replying
$tinyib_anonymous = ['Anonymous'];    // Default name (or names)
$tinyib_capcodes = [['Admin', 'red'], ['Mod', 'purple']]; // Administrator and moderator capcode label and color
...
//   Empty array to disable
$tinyib_embeds = [
	'SoundCloud' => 'https://soundcloud.com/oembed?format=json&url=TINYIBEMBED',
...
define('TINYIB_TRIPSEED', 'ddsffgdsgf');        // Enter some random text  (used when generating secure tripcodes, hashing passwords and hashing IP addresses)
...
define('TINYIB_DBPATH', '.tinyib.db');  // SQLite database file path

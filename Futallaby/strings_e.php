...
define('S_UPGOOD', ' File uploaded!<br><br>');					//Defines message to be displayed when file is successfully uploaded
...
define('S_SQLCONF', 'Database connection failure');		//MySQL connection failure
define('S_SQLDBSF', 'Database error, check SQLite file path<br>');	//database select failure
define('S_TCREATE', 'Creating table!<br>\n');	//creating table
define('S_TCREATEF', 'Unable to create table!<br>');		//table creation failed
define('S_SQLFAIL', 'Critical database problem!<br>');		//SQL Failure
?>

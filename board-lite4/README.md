...
- Reply backlinks, sticky and locked threads, reports, moderator editing, image replacement, and soft deletion
...
- Compact posting forms, a collapsed **New** control, top-of-thread replies, two-reply board previews, and built-in style choices
...
It exercises migrations, posting and board-local numbering, references and backlinks, safe rendering, reports, moderator post editing, attachment replacement/removal, soft deletion, two-reply board previews, privacy-safe schema checks, image processing (when GD is available), and complete board and thread requests.

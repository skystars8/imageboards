...
final readonly class PublicController
{
    ...
    public function reportPost(Request $request, array $parameters): Response
    {
        ...
        $this->captcha->validate(
            ...
            $this->reportCaptchaPurpose($board['slug'], (int) $post['post_no']),
        );
    ...
    private function reportCaptchaPurpose(string $boardSlug, int $postNo): string
    {
        return sprintf('report:%s:%d', $boardSlug, $postNo);
    }

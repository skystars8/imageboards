...
<head>
    ...
    <link rel="stylesheet" href="<?= setup_escape($basePath . '/assets/css/app.css') ?>">
    <link rel="stylesheet" href="<?= setup_escape($basePath . '/assets/css/themes/checkmate.css') ?>">
</head>
<body>
<nav class="board-list" aria-label="Setup">
    [ Chessboard Lite ]
</nav>
<header class="board-heading">
    <h1>Chessboard Lite</h1>
    <div class="board-subtitle">First-run setup</div>
</header>
...
<main class="page setup-page">
    <section class="auth-card setup-card">
        ...
        <?php else: ?>
            ...
            <p>
                SQLite, upload folders, and the initial
...
<footer class="footer">
    - Chessboard Lite · PHP 8.4 + SQLite 3 -
</footer>
</body>
</html>

...
Use SQLite3 for a compact database, or flatfile for maximum portability. By default it is set
to flatfile.
...
define('TINYIB_CAPTCHA', '');         // Reduce spam by requiring users to pass a CAPTCHA when posting a new thread: simple  ['' to disable]
define('TINYIB_REPLYCAPTCHA', '');    // Reduce spam by requiring users to pass a CAPTCHA when posting a reply: simple  ['' to disable]
define('TINYIB_REPORTCAPTCHA', '');   // Reduce invalid reports by requiring users to pass a CAPTCHA when reporting: simple  ['' to disable]
define('TINYIB_MANAGECAPTCHA', '');   // Improve security by requiring users to pass a CAPTCHA when logging in to the management panel: simple  ['' to disable]
...
define('TINYIB_BACKLINKS', false);     // Display reflinks to replies that reference a post
define('TINYIB_CATALOG', false);       // Generate catalog page
define('TINYIB_JSON', false);          // Generate JSON files
...
define('TINYIB_TRIPSEED', '34564356453');        // Enter some random text  (used when generating secure tripcodes and hashing passwords)
...
define('TINYIB_MODPASS', 'bbb');         // Moderator password  ['' to disable]

// Database
//   Supported modes: flatfile / sqlite3
define('TINYIB_DBMODE', 'flatfile'); // Storage mode

// Flat-file configuration
//   For best protection, place this directory outside the public web root when your host permits it.
define('TINYIB_FLATFILE_PATH', __DIR__ . '/inc/database/flatfile/data');

// SQLite3 configuration
define('TINYIB_DBPATH', '.tinyib.db');                   // SQLite database path
define('TINYIB_DBACCOUNTS', 'accounts');                 // Staff accounts table
define('TINYIB_DBKEYWORDS', 'keywords');                 // Keywords table
define('TINYIB_DBLOGS', 'logs');                         // Staff logs table
define('TINYIB_DBPOSTS', TINYIB_BOARD . '_posts');       // Posts table
define('TINYIB_DBREPORTS', TINYIB_BOARD . '_reports');   // Reports table

...
This build targets PHP 8.5 and uses the SQLite3 extension exclusively.
...
// Date and time
define('TINYIB_TIMEZONE', 'UTC');              // See https://php.net/manual/en/timezones.php - e.g. America/Los_Angeles
define('TINYIB_DATEFMT', 'y/m/d(D)H:i:s');     // Date and time format  (see php.net/date)

...
'; ?><?php endif; ?><?php echo '
'; ?><?php if (view_get($__ctx, 'config.captcha.provider') == 'recaptcha'): ?><?php echo '<script src="https://www.recaptcha.net/recaptcha/api.js" async defer></script>'; ?><?php endif; ?><?php echo '
'; ?><?php if (view_get($__ctx, 'config.captcha.provider') == 'hcaptcha'): ?><?php echo '<script src="https://js.hcaptcha.com/1/api.js" async defer></script>'; ?><?php endif; ?><?php echo '
'; ?>